...
const { value: rePassword,errorMessage: rePasswordError} = useField<string>('rePassword')
...
const { value: bdMonth,   errorMessage: bdMonthError   } = useField<string>('bdMonth')
    ...
    <div class="sign-form-content">
      <form class="sign-form" @submit.prevent="onSubmit">
        ...
        <div class="form-top-group">
          <div class="form-account-and-pass">
            ...
            <div class="account-group">
              ...
              <input v-model="account" type="text" class="account-input" :class="{ 'input-error': accountError }" />
            ...
            <div class="pass-group">
              ...
              <input v-model="password" type="password" class="password-input" :class="{ 'input-error': passwordError }" />
            ...
            <div class="confirm-pass-group">
              ...
              <input v-model="rePassword" type="password" class="confirm-password-input" :class="{ 'input-error': rePasswordError }" />
              <span v-if="rePasswordError" class="error-msg">{{ rePasswordError }}</span>
            </div>
          </div>

          <!-- 頭像上傳 -->
          <div class="signup-photo-group" @click="triggerFileInput">
            <img v-if="photoUrl" :src="photoUrl" class="signup-photo" alt="頭像預覽" />
        ...
        <div class="name-group">
          <label>姓名</label>
          <input v-model="name" type="text" class="sign-name" :class="{ 'input-error': nameError }" />
          <span v-if="nameError" class="error-msg">{{ nameError }}</span>
          <label>匿稱</label>
          <input v-model="alias" type="text" class="sign-alias" :class="{ 'input-error': aliasError }" />
        ...
        <div class="email-group">
          ...
          <input v-model="email" type="email" class="email-input" :class="{ 'input-error': emailError }" />
        ...
        <div class="phone-group">
          ...
          <input v-model="phone" type="text" class="phone-input" :class="{ 'input-error': phoneError }" />
        ...
        <div class="birthday-group">
          ...
          <input v-model="bdYear"  type="text" class="bd-year"  placeholder="年" :class="{ 'input-error': bdYearError  }" /> /
          <input v-model="bdMonth" type="text" class="bd-mon"   placeholder="月" :class="{ 'input-error': bdMonthError }" /> /
          <input v-model="bdDay"   type="text" class="bd-day"   placeholder="日" :class="{ 'input-error': bdDayError   }" />
          <span v-if="bdYearError || bdMonthError || bdDayError" class="error-msg">
...
.signup-photo-group {
  ...
  &:hover { background-color: rgba(255, 255, 255, 0.516); }
}
...
.bd-year  { margin-right: 5px; }
.bd-mon   { margin: 0 5px; }
.bd-day   { margin-left: 5px; }
...
.agree-check {
  ...
  span { color: #fff; font-size: 18px; margin-left: 6px; }
}
